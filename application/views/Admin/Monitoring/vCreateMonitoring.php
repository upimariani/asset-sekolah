				...
				<div class="card card-outline card-info">
					...
					<div class="card-body pad">
						...
						<div class="mb-3">
							...
							<textarea class="textarea" name="akibat" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
							<?= form_error('akibat', '<small class="text-danger pl-3">', '</small>'); ?>

						</div>
						<div class="mb-3">
							<label for="exampleInputPassword1">Monitoring</label>
							<textarea class="textarea" name="monitoring" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
							<?= form_error('monitoring', '<small class="text-danger pl-3">', '</small>'); ?>

						</div>
						<div class="mb-3">
							<label for="exampleInputPassword1">Pemeliharaan</label>
							<textarea class="textarea" name="pemeliharaan" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
							<?= form_error('pemeliharaan', '<small class="text-danger pl-3">', '</small>'); ?>

						</div>
						<div class="mb-3">
							<label for="exampleInputPassword1">Jumlah</label>
							<input class="form-control" name="jml" placeholder="Jumlah Kerusakan">
							<?= form_error('jml', '<small class="text-danger pl-3">', '</small>'); ?>

						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Gambar Hasil Monitoring</label>
